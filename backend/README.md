...
## Project Structure
    ...
    ├── testapiautosetting_122780  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_122780`
...
2. Clone this repo and `cd testapiautosetting_122780`
